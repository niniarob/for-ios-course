        ...
        <FullpageSection className="fullpage-section bck-img-two same-style-bck-img">
          <div className="content">
            ...
            <div className="lists">
              ...
              >
                <p>
                  <span>* Accessibility: </span> HIG დიზაინის რეკომენდაციებს
            ...
            <div className="des-img proreate-img-text">
              ...
              >
                ...
                <p className="description proreate-desc">
                  ...
                  ფუნქციები,რომლებიც მხეველობა დარღვეულ ან დაქვეითებულ
          ...
          <div className="content">
            <div className="gestures-content">
              ...
              >
                ...
                რამდენიმე ფაილის გახსნა და ბევრად კომპორტულ გარემოში მუშაობა{" "}
              </motion.p>
            </div>
          </div>
        </FullpageSection>
          ...
          <div className="content">
            <div className="gestures-content ">
              ...
              >
                ...
                Procreate მუდმივად ითვალისწინებს მომხმარებელთა რეკომენდაციებს და
                ხვეწავს აპს, იმისდა მიხედვით თუ რის საშუალებას აძლევს
                iOS(HIG)-ი. Procreate გვთავაზობს ნათელ და ლაკონურ მითითებებს
                ...
                ფენების მენეჯმენტი, აპლიკაცია მოიცავს ფენების მართვის მძლავრ
